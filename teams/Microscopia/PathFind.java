...
public class PathFind {
	...
	public static void findHQLocationTo(MapLocation location, int pathNum) throws GameActionException {
		rc.broadcast(Broadcast.HQ_PATH_LOCATION_CHANNEL[pathNum], Movement.locToInt(location));
	...
	public static int distanceSquaredToPathLocation(int pathNum) throws GameActionException {
		return rc.getLocation().distanceSquaredTo(Movement.intToLoc(rc.readBroadcast(Broadcast.HQ_PATH_LOCATION_CHANNEL[PathFind.FRIENDLY_PASTR_PATH_NUM])));
	}
		
	public static void setHQPathNotFound(int pathNum) throws GameActionException {
		rc.broadcast(Broadcast.HQ_PATH_FOUND_CHANNEL[pathNum], -1);
	}
	...
	public static boolean isHQPathFound(int pathNum) throws GameActionException {
		return rc.readBroadcast(Broadcast.HQ_PATH_FOUND_CHANNEL[pathNum]) == 1;
	} 
